...
const defaultData: ChartData[] = [
  { name: "Referral Income", value: 4200 },
  { name: "Binary Income", value: 6800 },
  { name: "Level Income", value: 2500 },
  { name: "Royalty Bonus", value: 1500 },
];
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-center mb-6 relative z-10">
        ...
        <button className="p-2 rounded-full text-slate-400 hover:text-white hover:bg-white/10 transition">
