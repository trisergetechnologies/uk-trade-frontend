...
export default function ProfileView() {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto overflow-x-auto overscroll-x-contain [-webkit-overflow-scrolling:touch]">
      <div className="min-w-full bg-[#050816] border border-white/10 rounded-2xl p-4 sm:p-6 shadow-xl">
        ...
        <div className="space-y-4 text-sm">
          <div className="flex min-w-0 items-center gap-3 bg-white/5 p-3 rounded-lg">
            <User size={16} className="text-indigo-400" />
            <span className="truncate">{user.name}</span>
          </div>

          <div className="flex items-center gap-3 bg-white/5 p-3 rounded-lg min-w-0">
          ...
          <div className="flex min-w-0 items-center gap-3 bg-white/5 p-3 rounded-lg">
            ...
            <span className="truncate">{user.userCode || user.id}</span>
          </div>

          {user.referralCode && (
            <div className="overflow-x-auto overscroll-x-contain rounded-lg bg-white/5 [-webkit-overflow-scrolling:touch]">
              <div className="min-w-[340px] space-y-3 p-3 text-xs text-slate-400 sm:min-w-0">
                ...
                <div className="flex min-w-0 items-center gap-2 rounded-lg border border-white/10 bg-black/20 px-2 py-1.5">
                  ...
                  <span className="block whitespace-nowrap text-[11px] text-slate-300">{referralUrl || "Generating..."}</span>
                </div>
        ...
        <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:gap-4">
          <Link
            ...
            className="text-center bg-gradient-to-r from-indigo-600 to-purple-600 py-2 rounded-lg sm:flex-1"
          >
            Edit Profile
          </Link>
          ...
          <Link
            ...
            className="text-center border border-white/10 py-2 rounded-lg hover:bg-white/5 sm:flex-1"
          >
            Change Password
          </Link>
        </div>
