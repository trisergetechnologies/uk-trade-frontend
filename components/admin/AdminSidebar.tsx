...
const MENU = [
  ...
  { name: "User passwords", href: "/admindashboard/user-passwords", icon: KeyRound },
  { name: "Credit wallet", href: "/admindashboard/fund-transfer", icon: Send },
  { name: "Transaction logs", href: "/admindashboard/transaction-logs", icon: Receipt },
  { name: "Community", href: "/admindashboard/community", icon: GitBranch },
  ...
  { name: "KYC", href: "/admindashboard/kyc", icon: IdCard },
